...
client = openai.OpenAI(
	api_key="${b||"YOUR_LITELLM_API_KEY"}",
	base_url="${I}"
)`;switch(_){case o.CHAT:{let e=Object.keys(w).length>0,a="";if(e){let e=JSON.stringify({metadata:w},null,2).split("\n").map(e=>" ".repeat(4)+e).join("\n").trim();a=`,
